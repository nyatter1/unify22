...
export const CARD_STYLES: CardStyle[] = [
  ...
  { "id":"meme-lord", "name":"Meme Lord", "category":"Funny", "bgClass":"bg-slate-900/80", "borderClass":"border-slate-400/40 shadow-[0_6px_18px_rgba(148,163,184,0.06)]", "textClass":"text-amber-300 font-black tracking-wide", "animationClass":"animate-wiggle" },
  { "id":"chuckle-chief", "name":"Chuckle Chief", "category":"Funny", "bgClass":"bg-blue-50", "borderClass":"border-blue-300 shadow-[0_8px_24px_rgba(59,130,246,0.08)]", "textClass":"text-blue-600 font-bold uppercase", "animationClass":"animate-bounce-slow" },
  { "id":"snicker-supreme", "name":"Snicker Supreme", "category":"Funny", "bgClass":"bg-rose-50", "borderClass":"border-rose-300/50", "textClass":"text-rose-600 font-extrabold", "animationClass":"animate-pulse-slow" },
  { "id":"guffaw-guy", "name":"Guffaw Guy", "category":"Funny", "bgClass":"bg-indigo-50", "borderClass":"border-indigo-300 shadow-[0_4px_12px_rgba(99,102,241,0.08)]", "textClass":"text-indigo-600 font-bold", "animationClass":"animate-tilt" },
  { "id":"haha-honcho", "name":"Haha Honcho", "category":"Funny", "bgClass":"bg-lime-50", "borderClass":"border-lime-300/60 shadow-[0_6px_18px_rgba(132,204,22,0.08)]", "textClass":"text-lime-700 font-black", "animationClass":"animate-wobble" },
  { "id":"snort-sultan", "name":"Snort Sultan", "category":"Funny", "bgClass":"bg-violet-50", "borderClass":"border-violet-300", "textClass":"text-violet-600 font-bold italic", "animationClass":"animate-pulse-fast" },
  { "id":"tickle-titan", "name":"Tickle Titan", "category":"Funny", "bgClass":"bg-gradient-to-br from-yellow-50 to-pink-50", "borderClass":"border-yellow-200/40 shadow-[0_8px_30px_rgba(253,230,138,0.08)]", "textClass":"text-pink-500 font-black", "animationClass":"animate-bounce-slow" },

  { "id":"quirk-king", "name":"Quirk King", "category":"Funny", "bgClass":"bg-amber-50", "borderClass":"border-amber-300/40", "textClass":"text-amber-700 font-bold", "animationClass":"animate-rotate-3" },
  { "id":"silly-savant", "name":"Silly Savant", "category":"Funny", "bgClass":"bg-fuchsia-50", "borderClass":"border-fuchsia-300/40", "textClass":"text-fuchsia-600 font-black", "animationClass":"animate-bounce-fast" },
  { "id":"banter-baron", "name":"Banter Baron", "category":"Funny", "bgClass":"bg-sky-50", "borderClass":"border-sky-300 shadow-[0_6px_20px_rgba(56,189,248,0.06)]", "textClass":"text-sky-600 font-bold", "animationClass":"animate-wiggle" },
  { "id":"gag-guru", "name":"Gag Guru", "category":"Funny", "bgClass":"bg-rose-50/60", "borderClass":"border-rose-200/50", "textClass":"text-rose-600 font-extrabold", "animationClass":"animate-pulse-slow" },
  { "id":"zany-zebra", "name":"Zany Zebra", "category":"Funny", "bgClass":"bg-black/80 bg-[length:200%_200%] bg-[radial-gradient(ellipse_at_center,rgba(255,255,255,0.03),transparent)]", "borderClass":"border-white/10", "textClass":"text-white/70 font-mono", "animationClass":"animate-glow" },
  { "id":"crack-up", "name":"Crack Up", "category":"Funny", "bgClass":"bg-yellow-100", "borderClass":"border-yellow-400/50", "textClass":"text-yellow-700 font-black", "animationClass":"animate-bounce-slow" },
  { "id":"knee-slapper", "name":"Knee Slapper", "category":"Funny", "bgClass":"bg-orange-50", "borderClass":"border-orange-300/50", "textClass":"text-orange-600 font-bold", "animationClass":"animate-wobble" },
  { "id":"smirk-spree", "name":"Smirk Spree", "category":"Funny", "bgClass":"bg-slate-900/70", "borderClass":"border-slate-500/30", "textClass":"text-emerald-300 font-semibold", "animationClass":"animate-tilt" },
  { "id":"gaggle-chief", "name":"Gaggle Chief", "category":"Funny", "bgClass":"bg-emerald-50/70", "borderClass":"border-emerald-300", "textClass":"text-emerald-700 font-black", "animationClass":"animate-bounce-slow" },
  { "id":"laugh-lad", "name":"Laugh Lad", "category":"Funny", "bgClass":"bg-purple-50", "borderClass":"border-purple-300", "textClass":"text-purple-700 font-bold", "animationClass":"animate-pulse-slow" },

  { "id":"mirth-maker", "name":"Mirth Maker", "category":"Funny", "bgClass":"bg-gradient-to-br from-pink-50 to-indigo-50", "borderClass":"border-pink-200/40 shadow-[0_6px_18px_rgba(139,92,246,0.06)]", "textClass":"text-indigo-600 font-black", "animationClass":"animate-wiggle" },
  { "id":"jest-jet", "name":"Jest Jet", "category":"Funny", "bgClass":"bg-sky-50/80", "borderClass":"border-sky-300/50", "textClass":"text-sky-700 font-bold tracking-wide", "animationClass":"animate-float" },
  { "id":"quip-queen", "name":"Quip Queen", "category":"Funny", "bgClass":"bg-rose-50/60", "borderClass":"border-rose-300", "textClass":"text-rose-700 font-serif italic", "animationClass":"animate-pulse-slow" },
  { "id":"banter-bot", "name":"Banter Bot", "category":"Funny", "bgClass":"bg-zinc-900/70", "borderClass":"border-zinc-600", "textClass":"text-cyan-300 font-mono", "animationClass":"animate-glitch" },
  { "id":"punchline-pro", "name":"Punchline Pro", "category":"Funny", "bgClass":"bg-yellow-50/80", "borderClass":"border-yellow-400 shadow-[0_6px_20px_rgba(250,204,21,0.12)]", "textClass":"text-yellow-700 font-black uppercase", "animationClass":"animate-bounce-slow" },
  { "id":"shtick-star", "name":"Shtick Star", "category":"Funny", "bgClass":"bg-indigo-50/80", "borderClass":"border-indigo-300/40", "textClass":"text-indigo-700 font-bold", "animationClass":"animate-wobble" },
  { "id":"gag-gaffer", "name":"Gag Gaffer", "category":"Funny", "bgClass":"bg-amber-50/80", "borderClass":"border-amber-300/40", "textClass":"text-amber-700 font-extrabold", "animationClass":"animate-tilt" },
  { "id":"chortle-champ", "name":"Chortle Champ", "category":"Funny", "bgClass":"bg-emerald-50/80", "borderClass":"border-emerald-300/40", "textClass":"text-emerald-700 font-black", "animationClass":"animate-bounce-fast" },
  { "id":"rimshot-royal", "name":"Rimshot Royal", "category":"Funny", "bgClass":"bg-slate-800", "borderClass":"border-amber-400/30 shadow-[0_10px_30px_rgba(245,158,11,0.06)]", "textClass":"text-amber-300 font-bold", "animationClass":"animate-pulse-slow" },
  { "id":"gaggle-gizmo", "name":"Gaggle Gizmo", "category":"Funny", "bgClass":"bg-gradient-to-r from-lime-50 to-amber-50", "borderClass":"border-lime-300/40", "textClass":"text-lime-700 font-mono", "animationClass":"animate-wiggle" },

  { "id":"whoopee-wizard", "name":"Whoopee Wizard", "category":"Funny", "bgClass":"bg-pink-50/70", "borderClass":"border-pink-300", "textClass":"text-pink-700 font-black", "animationClass":"animate-float" },
  { "id":"snafu-sensei", "name":"Snafu Sensei", "category":"Funny", "bgClass":"bg-slate-900/80", "borderClass":"border-red-400/30", "textClass":"text-red-400 font-bold", "animationClass":"animate-glitch" },
  { "id":"giggly-gopher", "name":"Giggly Gopher", "category":"Funny", "bgClass":"bg-amber-50/70", "borderClass":"border-amber-300/40", "textClass":"text-amber-800 font-extrabold", "animationClass":"animate-bounce-slow" },
  { "id":"jest-jockey", "name":"Jest Jockey", "category":"Funny", "bgClass":"bg-cyan-50", "borderClass":"border-cyan-300/40", "textClass":"text-cyan-700 font-bold", "animationClass":"animate-tilt" },
  { "id":"silly-seraph", "name":"Silly Seraph", "category":"Funny", "bgClass":"bg-white/5 backdrop-blur-sm", "borderClass":"border-white/10 shadow-inner", "textClass":"text-white/60 font-light tracking-wide", "animationClass":"animate-glow-slow" },
  { "id":"meme-miner", "name":"Meme Miner", "category":"Funny", "bgClass":"bg-zinc-900", "borderClass":"border-amber-500/30", "textClass":"text-amber-300 font-mono", "animationClass":"animate-pulse-slow" },
  { "id":"jolly-jester", "name":"Jolly Jester", "category":"Funny", "bgClass":"bg-gradient-to-br from-purple-50 to-pink-50", "borderClass":"border-purple-300/40", "textClass":"text-purple-700 font-black italic", "animationClass":"animate-wiggle" },
  { "id":"chuckle-chimp", "name":"Chuckle Chimp", "category":"Funny", "bgClass":"bg-green-50", "borderClass":"border-green-300", "textClass":"text-green-700 font-extrabold", "animationClass":"animate-bounce-fast" },
  { "id":"gag-galaxy", "name":"Gag Galaxy", "category":"Funny", "bgClass":"bg-black/80 bg-[url('/patterns/galaxy.svg')] bg-cover", "borderClass":"border-cyan-400/20", "textClass":"text-cyan-300 font-bold", "animationClass":"animate-starfield" },

  { "id":"ha-ha-harbor", "name":"Ha-Ha Harbor", "category":"Funny", "bgClass":"bg-sky-50/80", "borderClass":"border-sky-300/40", "textClass":"text-sky-700 font-semibold", "animationClass":"animate-float" },
  { "id":"zinger-zulu", "name":"Zinger Zulu", "category":"Funny", "bgClass":"bg-amber-50/80", "borderClass":"border-amber-300/40", "textClass":"text-amber-800 font-black", "animationClass":"animate-tilt" },
  { "id":"smile-surgeon", "name":"Smile Surgeon", "category":"Funny", "bgClass":"bg-white/6", "borderClass":"border-white/10", "textClass":"text-white/70 font-mono", "animationClass":"animate-pulse-slow" },
  { "id":"gaggle-godfather", "name":"Gaggle Godfather", "category":"Funny", "bgClass":"bg-gray-800/80", "borderClass":"border-yellow-400/20", "textClass":"text-yellow-300 font-black", "animationClass":"animate-wiggle" },
  { "id":"chucklesmith", "name":"Chucklesmith", "category":"Funny", "bgClass":"bg-red-50", "borderClass":"border-red-300/40", "textClass":"text-red-700 font-bold", "animationClass":"animate-bounce-slow" },
  { "id":"gag-grenade", "name":"Gag Grenade", "category":"Funny", "bgClass":"bg-gradient-to-br from-red-50 to-yellow-50", "borderClass":"border-red-300/30", "textClass":"text-red-700 font-black", "animationClass":"animate-pulse-fast" },
  { "id":"shtick-shaman", "name":"Shtick Shaman", "category":"Funny", "bgClass":"bg-indigo-50", "borderClass":"border-indigo-300", "textClass":"text-indigo-700 font-serif italic", "animationClass":"animate-wobble" },
  { "id":"prank-prince", "name":"Prank Prince", "category":"Funny", "bgClass":"bg-lime-50/70", "borderClass":"border-lime-300", "textClass":"text-lime-800 font-extrabold", "animationClass":"animate-bounce-fast" },
  { "id":"snicker-ninja", "name":"Snicker Ninja", "category":"Funny", "bgClass":"bg-zinc-900", "borderClass":"border-green-400/30", "textClass":"text-green-300 font-mono", "animationClass":"animate-glitch-fast" },

  { "id":"mirth-marshal", "name":"Mirth Marshal", "category":"Funny", "bgClass":"bg-white/6", "borderClass":"border-amber-300/30", "textClass":"text-amber-400 font-black", "animationClass":"animate-tilt" },
  { "id":"glee-gal", "name":"Glee Gal", "category":"Funny", "bgClass":"bg-rose-50", "borderClass":"border-rose-300/40", "textClass":"text-rose-700 font-bold", "animationClass":"animate-pulse-slow" },
  { "id":"wit-wizard", "name":"Wit Wizard", "category":"Funny", "bgClass":"bg-gradient-to-br from-blue-50 to-indigo-50", "borderClass":"border-blue-300/40", "textClass":"text-blue-700 font-black", "animationClass":"animate-wiggle" },
  { "id":"jape-jojoba", "name":"Jape Jojoba", "category":"Funny", "bgClass":"bg-slate-50", "borderClass":"border-slate-300", "textClass":"text-slate-700 font-semibold", "animationClass":"animate-float" },
...
export const PROFILE_EFFECTS: ProfileEffect[] = [
  ...
  { id: 'effect-triggered-fast', name: 'Fast Triggered', category: 'Funny', className: 'effect-triggered-fast' },
  { id: 'effect-hypnotoad-fast', name: 'Fast Hypno', category: 'Funny', className: 'effect-hypnotoad-fast' },
  { id: 'effect-stonks-up', name: 'Stonks Up', category: 'Funny', className: 'effect-stonks-up' },
  { id: 'effect-not-stonks-down', name: 'Not Stonks Down', category: 'Funny', className: 'effect-not-stonks-down' },
  { id: 'effect-uwu-hearts-many', name: 'Many UwU Hearts', category: 'Funny', className: 'effect-uwu-hearts-many' },
  { id: 'effect-dvd-fast', name: 'Fast DVD Bounce', category: 'Funny', className: 'effect-dvd-fast' },
  { id: 'effect-jello-fast', name: 'Fast Jello Wiggle', category: 'Funny', className: 'effect-jello-fast' },
  { id: 'effect-rainbow-puke-fast', name: 'Fast Rainbow Puke', category: 'Funny', className: 'effect-rainbow-puke-fast' },
  { id: 'effect-brain-empty-fast', name: 'Fast Brain Empty', category: 'Funny', className: 'effect-brain-empty-fast' },
  { id: 'effect-sweat-fast', name: 'Fast Sweating', category: 'Funny', className: 'effect-sweat-fast' },
  { id: 'effect-sus-fast', name: 'Fast Sus Flash', category: 'Funny', className: 'effect-sus-fast' },
  { id: 'effect-clown-fast', name: 'Fast Clown Mode', category: 'Funny', className: 'effect-clown-fast' },
  { id: 'effect-wasted-fast', name: 'Fast Wasted', category: 'Funny', className: 'effect-wasted-fast' },
  { id: 'effect-nyan-fast', name: 'Fast Nyan Trail', category: 'Funny', className: 'effect-nyan-fast' },
  ...
  { id: 'effect-shake', name: 'Shake', category: 'Elements', className: 'effect-shake' },
  { id: 'effect-spin', name: 'Spin', category: 'Elements', className: 'effect-spin' },
  { id: 'effect-fade', name: 'Fade', category: 'Elements', className: 'effect-fade' },
  { id: 'effect-zoom', name: 'Zoom', category: 'Elements', className: 'effect-zoom' },
  { id: 'effect-rotate', name: 'Rotate', category: 'Elements', className: 'effect-rotate' },
  { id: 'effect-flip', name: 'Flip', category: 'Elements', className: 'effect-flip' },
  { id: 'effect-bounce', name: 'Bounce', category: 'Elements', className: 'effect-bounce' },
  { id: 'effect-slide', name: 'Slide', category: 'Elements', className: 'effect-slide' },
  { id: 'effect-blur', name: 'Blur', category: 'Elements', className: 'effect-blur' },
  { id: 'effect-grayscale', name: 'Grayscale', category: 'Elements', className: 'effect-grayscale' },
  { id: 'effect-sepia', name: 'Sepia', category: 'Elements', className: 'effect-sepia' },
  { id: 'effect-invert', name: 'Invert', category: 'Elements', className: 'effect-invert' },
  { id: 'effect-hue-rotate', name: 'Hue Rotate', category: 'Elements', className: 'effect-hue-rotate' },
  { id: 'effect-saturate', name: 'Saturate', category: 'Elements', className: 'effect-saturate' },
  { id: 'effect-brightness', name: 'Brightness', category: 'Elements', className: 'effect-brightness' },
  { id: 'effect-contrast', name: 'Contrast', category: 'Elements', className: 'effect-contrast' }
];
...
export const BORDERS: Border[] = (() => {
  ...
  borders.push(
    ...
    { id: 'border-rainbow-thick', name: 'Rainbow Thick', category: 'Special', className: 'border-transparent border-8 bg-clip-border bg-gradient-to-r from-red-500 via-yellow-500 via-green-500 via-blue-500 to-purple-500 animate-[gradient_3s_linear_infinite] bg-[length:200%_auto]' },
    ...
    { id: 'border-neon-slate', name: 'Neon Slate', category: 'Special', className: 'border-slate-500 border-4 shadow-[0_0_20px_rgba(100,116,139,0.8)]' },
    { id: 'border-neon-zinc', name: 'Neon Zinc', category: 'Special', className: 'border-zinc-500 border-4 shadow-[0_0_20px_rgba(113,113,122,0.8)]' },
    { id: 'border-neon-stone', name: 'Neon Stone', category: 'Special', className: 'border-stone-500 border-4 shadow-[0_0_20px_rgba(120,113,108,0.8)]' },
    ...
    { id: 'border-glass-blue', name: 'Glass Blue', category: 'Special', className: 'border-blue-500/20 border-4 backdrop-blur-md' },
    { id: 'border-glass-red', name: 'Glass Red', category: 'Special', className: 'border-red-500/20 border-4 backdrop-blur-md' },
    { id: 'border-glass-green', name: 'Glass Green', category: 'Special', className: 'border-green-500/20 border-4 backdrop-blur-md' },
    { id: 'border-glass-purple', name: 'Glass Purple', category: 'Special', className: 'border-purple-500/20 border-4 backdrop-blur-md' },
    { id: 'border-glass-pink', name: 'Glass Pink', category: 'Special', className: 'border-pink-500/20 border-4 backdrop-blur-md' },
    { id: 'border-glass-yellow', name: 'Glass Yellow', category: 'Special', className: 'border-yellow-500/20 border-4 backdrop-blur-md' },
    { id: 'border-glass-orange', name: 'Glass Orange', category: 'Special', className: 'border-orange-500/20 border-4 backdrop-blur-md' },
    { id: 'border-glass-cyan', name: 'Glass Cyan', category: 'Special', className: 'border-cyan-500/20 border-4 backdrop-blur-md' },
    { id: 'border-glass-lime', name: 'Glass Lime', category: 'Special', className: 'border-lime-500/20 border-4 backdrop-blur-md' },
    { id: 'border-glass-teal', name: 'Glass Teal', category: 'Special', className: 'border-teal-500/20 border-4 backdrop-blur-md' },
    { id: 'border-glass-indigo', name: 'Glass Indigo', category: 'Special', className: 'border-indigo-500/20 border-4 backdrop-blur-md' },
    { id: 'border-glass-violet', name: 'Glass Violet', category: 'Special', className: 'border-violet-500/20 border-4 backdrop-blur-md' },
    { id: 'border-glass-fuchsia', name: 'Glass Fuchsia', category: 'Special', className: 'border-fuchsia-500/20 border-4 backdrop-blur-md' },
    { id: 'border-glass-rose', name: 'Glass Rose', category: 'Special', className: 'border-rose-500/20 border-4 backdrop-blur-md' },
    { id: 'border-glass-sky', name: 'Glass Sky', category: 'Special', className: 'border-sky-500/20 border-4 backdrop-blur-md' },
    { id: 'border-glass-emerald', name: 'Glass Emerald', category: 'Special', className: 'border-emerald-500/20 border-4 backdrop-blur-md' },
    { id: 'border-glass-amber', name: 'Glass Amber', category: 'Special', className: 'border-amber-500/20 border-4 backdrop-blur-md' },
    { id: 'border-glass-slate', name: 'Glass Slate', category: 'Special', className: 'border-slate-500/20 border-4 backdrop-blur-md' },
    { id: 'border-glass-zinc', name: 'Glass Zinc', category: 'Special', className: 'border-zinc-500/20 border-4 backdrop-blur-md' },
    { id: 'border-glass-stone', name: 'Glass Stone', category: 'Special', className: 'border-stone-500/20 border-4 backdrop-blur-md' },
    { id: 'border-solid-blue', name: 'Solid Blue', category: 'Basic', className: 'border-blue-600 border-4' },
    { id: 'border-solid-red', name: 'Solid Red', category: 'Basic', className: 'border-red-600 border-4' },
    { id: 'border-solid-green', name: 'Solid Green', category: 'Basic', className: 'border-green-600 border-4' },
    { id: 'border-solid-purple', name: 'Solid Purple', category: 'Basic', className: 'border-purple-600 border-4' },
    { id: 'border-solid-pink', name: 'Solid Pink', category: 'Basic', className: 'border-pink-600 border-4' },
    { id: 'border-solid-yellow', name: 'Solid Yellow', category: 'Basic', className: 'border-yellow-600 border-4' },
    { id: 'border-solid-orange', name: 'Solid Orange', category: 'Basic', className: 'border-orange-600 border-4' },
    { id: 'border-solid-cyan', name: 'Solid Cyan', category: 'Basic', className: 'border-cyan-600 border-4' },
    { id: 'border-solid-lime', name: 'Solid Lime', category: 'Basic', className: 'border-lime-600 border-4' },
    { id: 'border-solid-teal', name: 'Solid Teal', category: 'Basic', className: 'border-teal-600 border-4' }
  );
  return borders;
})();
