                ...
                >
                  <div className="space-y-4">
                    <div className="flex items-center justify-between p-3 rounded-xl bg-amber-500/5 border border-amber-500/10">
                      ...
                      <span className="text-lg font-serif italic text-amber-200">{user.gold.toLocaleString()}</span>
                    </div>
                    <div className="flex items-center justify-between p-3 rounded-xl bg-amber-500/5 border border-amber-500/10">
                      <div className="flex items-center gap-3">
                      ...
                      <span className="text-lg font-serif italic text-amber-200">{user.rubies.toLocaleString()}</span>
                    </div>
                  </div>
                </motion.div>
              )}
          ...
          <div className="p-6 border-t border-amber-900/10 bg-black/40">
            ...
            <div className="flex gap-2">
              <div className="flex-1 bg-amber-500/5 border border-amber-500/10 rounded-lg p-2 flex items-center justify-center gap-2">
                ...
                <span className="text-[10px] font-bold text-amber-200">{user.gold.toLocaleString()}</span>
              </div>
              <div className="flex-1 bg-amber-500/5 border border-amber-500/10 rounded-lg p-2 flex items-center justify-center gap-2">
                <Gem className="w-3 h-3 text-amber-500" />
                <span className="text-[10px] font-bold text-amber-200">{user.rubies.toLocaleString()}</span>
              </div>
            </div>
          </div>
        </aside>
